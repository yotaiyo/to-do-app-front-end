...
const todo0 = { id: 0, completed: false, deadline: undefined, text: 'todo0' }
const todo1 = { id: 1, completed: false, deadline: beforeCurrentTime1, text: 'todo1' }
const todo2 = { id: 2, completed: false, deadline: beforeCurrentTime2, text: 'todo2' }
const todo3 = { id: 3, completed: false, deadline: afterCurrentTime1, text: 'todo3' }
const todo4 = { id: 4, completed: false, deadline: afterCurrentTime2, text: 'todo4' }
const todo5 = { id: 5, completed: true, deadline: undefined, text: 'todo5' }
const todo6 = { id: 6, completed: true, deadline: beforeCurrentTime1, text: 'todo6' }
const todo7 = { id: 7, completed: true, deadline: afterCurrentTime1, text: 'todo7' }
